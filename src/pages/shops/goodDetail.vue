        ...
        <view class="goods-head">
          ...
          <view class="goods-con">
            ...
            <view class="shop-share">
              <u-button size="mini" :custom-style="customStyle" shape="circle">分享</u-button>
            </view>
            <view class="shop-detail">
              <view class="shop-detail-items">
                <text><text class="detail-num">21</text>天</text>
                <text>平均工时</text>
              </view>
              <view class="u-border-right text-gray line-right"></view>
              <view class="shop-detail-items">
                <text><text class="detail-num">9</text>小时</text>
                <text>平均响应</text>
              </view>
              <view class="u-border-right text-gray line-right"></view>
              <view class="shop-detail-items">
              ...
              <view class="u-border-right text-gray line-right"></view>
              <view class="shop-detail-items">
                <text><text class="detail-num">322</text></text>
                <text>收藏</text>
              </view>
            </view>
          </view>
        ...
        <view class="assess">
          <view class="assess-title">
            <view>
              ...
              <text class="u-font-28">客户评价 <text>(122)</text></text>
            </view>
