			...
			<view class="login-box u-margin-top-30">
				<u-form :model="form" ref="uForm">
					<u-form-item label="帐 号" style="white-space: nowrap;">
						<u-input @blur="validatePhone" v-model="form.phone" type="number" placeholder="输入你的帐号" placeholder-class="weight" placeholder-style="margin-left:20rpx"/>
					</u-form-item>
					<u-form-item label="验证码" style="white-space: nowrap">
					...
					<u-form-item label="密码" style="letter-spacing: 10rpx">
					...
					<u-form-item label="确认" style="letter-spacing: 10rpx">
					...
					<u-form-item label="邀请人" style="white-space: nowrap;">
