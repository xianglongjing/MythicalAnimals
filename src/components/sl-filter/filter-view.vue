            ...
            <view class="filter-content" v-for="(item, index) in menuList" :key="index" v-if="menuIndex == index">
                ...
                <view v-else>
                    ...
                    <view class="filter-content-detail">
                        <text v-for="(detailItem,idx) in selectDetailList" :key="idx" class='filter-content-detail-item-default' :style="{'background-color':detailItem.isSelected?themeColor:'#F8f8f8','color':detailItem.isSelected?'#FFFFFF':'#666666'}"
                              @tap="itemTap(idx,selectDetailList,item.isMutiple,item.key)">
                            {{detailItem.title}}
                        </text>
                    </view>
                    <view class="filter-content-footer">
                        <view class="filter-content-footer-item chongzhi" style="color: #777777; background-color: #f8f8f8;width:30%;" @tap="resetClick(selectDetailList,item.key)">
                            <text>重置</text>
                        </view>
...
<style>
    ...
    .filter-content-detail-item-default:first-child{
